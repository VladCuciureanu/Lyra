...
CREATE TABLE "SongsOnPlaylist" (
    ...
    CONSTRAINT "SongsOnPlaylist_pkey" PRIMARY KEY ("songId","playlistId")
);

-- CreateTable
CREATE TABLE "UsersOnPlaylist" (
    "userId" UUID NOT NULL,
    "playlistId" UUID NOT NULL,
    ...
    CONSTRAINT "UsersOnPlaylist_pkey" PRIMARY KEY ("userId","playlistId")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "SongsOnPlaylist_playlistId_order_key" ON "SongsOnPlaylist"("playlistId", "order");

-- CreateIndex
CREATE UNIQUE INDEX "UsersOnPlaylist_playlistId_isCreator_key" ON "UsersOnPlaylist"("playlistId", "isCreator");
...
-- AddForeignKey
ALTER TABLE "SongsOnPlaylist" ADD CONSTRAINT "SongsOnPlaylist_playlistId_fkey" FOREIGN KEY ("playlistId") REFERENCES "Playlist"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SongsOnPlaylist" ADD CONSTRAINT "SongsOnPlaylist_songId_fkey" FOREIGN KEY ("songId") REFERENCES "Song"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "UsersOnPlaylist" ADD CONSTRAINT "UsersOnPlaylist_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "UsersOnPlaylist" ADD CONSTRAINT "UsersOnPlaylist_playlistId_fkey" FOREIGN KEY ("playlistId") REFERENCES "Playlist"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
